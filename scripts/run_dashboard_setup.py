...
def check_requirements():
    ...
    if missing:
        ...
        for pkg in missing:
            print(f"   - {pkg}")
        print("\n[PKG] Installing missing packages...")
...
async def fix_database():
    ...
    print("[FIX] Fixing database schema...")
    ...
    try:
        ...
        async with aiosqlite.connect(db_manager.db_path) as db:
            ...
            if 'strategy' not in column_names:
                print("[FIX] Adding strategy column to positions table...")
        ...
        async with aiosqlite.connect(db_manager.db_path) as db:
            ...
            if 'strategy' not in column_names:
                print("[FIX] Adding strategy column to trade_logs table...")
...
async def main():
    ...
    if not Path("trading_dashboard.py").exists():
        ...
        print("[INFO] Make sure you're running this from the kalshi project root")
        return False
    
    # Check requirements
    print("[PKG] Checking requirements...")
    ...
    # Launch dashboard
    print("\n[WEB] Dashboard will open at: http://localhost:8501")
