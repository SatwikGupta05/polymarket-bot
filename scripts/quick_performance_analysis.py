...
async def run_quick_analysis():
    ...
    print("[START] QUICK TRADING PERFORMANCE ANALYSIS WITH GROK4")
    print("=" * 60)
    ...
    try:
        ...
        print("\n[STATS] Gathering portfolio data...")
        ...
        analysis_prompt = f"""
You are an expert quantitative trading analyst reviewing a Polymarket prediction market trading system.
...
"""
        ...
        try:
            ...
            if response:
                ...
                print(f"\n[SAVE] Analysis saved to: grok4_trading_analysis.txt")
                
            else:
                print("[FAIL] No analysis generated by Grok4")
                
        except Exception as ai_error:
            print(f"[WARN] Grok4 analysis failed: {ai_error}")
            print("\n[LIST] FALLBACK ANALYSIS:")
            print("-" * 40)
            ...
            if win_rate == 0 and trade_stats and trade_stats[0] > 0:
                print("[RED] CRITICAL: 0% win rate on completed trades - strategy needs immediate revision")
            
            if available_cash < 50:
                print("[RED] CRITICAL: Very low available cash - may block new opportunities")
            
            if len(active_positions) > 10:
                print("[WARN] HIGH: Many active positions - ensure proper risk management")
