...
def check_requirements():
    ...
    if missing_packages:
        ...
        for package in missing_packages:
            print(f"   - {package}")
        print()
        print("[PKG] Install missing packages:")
...
def launch_dashboard():
    ...
    if not dashboard_path.exists():
        ...
        print("[INFO] Make sure you're running this from the project root")
        return False
    ...
    print("[WEB] Launching dashboard...")
    print()
    print("[STATS] Dashboard will open in your browser at: http://localhost:8501")
