...
### 🔧 System Health
- **Connection status**: Polymarket API, database, LLM integration
...
- **Connection issues**: Verify Polymarket API connectivity and wallet configuration when live trading is enabled
