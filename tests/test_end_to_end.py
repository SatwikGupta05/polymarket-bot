...
async def test_full_trading_cycle():
    ...
    try:
        ...
        print("[BOT] Testing decision making process...")
        ...
        if position:
            ...
            if execution_result:
                ...
                print("[STATS] Position execution returned False (may be intentional based on market conditions)")
        else:
            print("[STATS] AI decided not to trade this market (valid outcome)")
