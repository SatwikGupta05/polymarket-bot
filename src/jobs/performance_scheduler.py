...
class PerformanceScheduler:
    ...
    def _run_daily_analysis(self) -> None:
        ...
        self.logger.info("[STATS] Running scheduled daily analysis")
    ...
    def _run_weekly_analysis(self) -> None:
        ...
        self.logger.info("[LIST] Running scheduled weekly deep analysis")
    ...
    async def _execute_weekly_analysis(self) -> None:
        ...
        try:
            ...
            self.logger.info(
                "[STATS] Weekly analysis completed",
    ...
    def _check_critical_issues(self) -> None:
        ...
        if critical_count > 0:
            self.logger.warning(
                f"[WARN] Ongoing critical issues detected: {critical_count}",
...
"""
    ...
    async def _handle_health_degradation_alert(self, report: Dict[str, Any], health_change: float) -> None:
        ...
        alert_message = f"""
[WARN] TRADING SYSTEM HEALTH DEGRADATION
...
"""
        ...
        self.logger.warning(
            "[WARN] Health degradation alert sent",
            health_change=health_change,
...
"""
    ...
    async def _save_weekly_report(self, weekly_report: Dict[str, Any]) -> None:
        ...
        self.logger.info(f"[LIST] Weekly report saved: {filename}")
    
    async def _send_weekly_summary(self, weekly_report: Dict[str, Any]) -> None:
        """Send weekly summary notification."""
        summary_message = f"""
[STATS] WEEKLY TRADING SYSTEM SUMMARY
